...
func (s *Store) GetChainPosition() (int64, string, bool, error) {
...
func (s *Store) UpsertChainPosition(blockHeight int64, blockHash string, waitingForNextHash bool) error {
